...
public boolean ai_paddle_3_enabled = false;
public boolean ai_paddle_4_enabled = false;
...
public Game(){
	...
	paddle_3=new Paddle(paddle_size_x/2+paddle_gap+dx,game_size[1]/2+dy,paddle_size_x,paddle_size_y);
	paddle_4=new Paddle(game_size[0]-paddle_size_x/2-paddle_gap+dx,game_size[1]/2+dy,paddle_size_x,paddle_size_y);
	
	Paddle test = new Paddle(paddle_size_y,paddle_radius, 8, dx, dy, Pointing.left);
	
	obstacles.add(test.p);
}
